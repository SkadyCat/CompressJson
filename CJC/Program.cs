...
namespace CJ_CSHARP
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //    manager.process("login.msg");
            //    test(manager, "Test2", "{\"id\":10,\"names\":[\"xw\",\"xm\",\"xl\"]}");
            ...
            //CJUtil.init();
            //CJUtil.load("login.msg");
            //byte[] buf = CJUtil.toBuffer("LoginRet", "{\"account\":\"ljy\",\"password\":\"12345678\"}");
            ////string[] js = CJUtil.toJson(buf);
            //CJReading.init();
            //CJReading.read(buf);
